...
export const Footer = () => {
    return (
        <>
            <footer className="bg-dark-green relative z-20">
                <div className="mx-auto max-w-screen-xl p-4 py-6 md:p-8 lg:p-10 lg:py-16">
                    <div className="text-center">
                        <a
                            href="#"
                            className="mb-5 flex items-center justify-center text-2xl font-semibold text-white"
                        >
                            <LogoCompleto className="h-10" />
                        </a>
                        <span className="block text-center text-sm text-gray-400">
                            © 2025 San Martín Innova™. Todos los derechos
                            reservados. Powered by{' '}
                            <a
                                href="https://ding.com.ar/"
                                target="_blank"
                                rel='noreferrer'
                                className="text-purple-600 hover:underline dark:text-blue-500"
                            >
                                Ding
                            </a>
                        </span>
